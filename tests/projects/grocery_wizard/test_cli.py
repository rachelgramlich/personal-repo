...
def test_cmd_grocery_passes_new_flags() -> None:
    from projects.grocery_wizard.cli import cmd_grocery
    ...
    with (
        patch("projects.grocery_wizard.cli.load_config"),
        patch("projects.grocery_wizard.cli.NotionRecipesDB"),
        patch("projects.grocery_wizard.grocery_list.run_grocery_list") as run_mock,
    ):
